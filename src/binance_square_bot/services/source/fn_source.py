...
严格格式要求：
- 推文总字符数：200-700字
- 话题标签：最多{self.max_hashtags}个，从#加密货币 #区块链 #Web3等贴合文章内容的标签
...
4. 结尾抛出问题引导读者评论
5. 总字符数：100-800字
6. 话题标签：最多{self.max_hashtags}个，如#加密货币 #区块链 #Web3等贴合文章内容的标签
7. 代币标签：最多{self.max_mentions}个，列出新闻内容提及的代币，没有就用$BTC $ETH
8. 段落之间空一行
9. 不要使用表情符号
10. 不要承诺收益，不要诱导投资
...
5. 结尾抛出问题引导读者评论
6. 总字符数：100-800字
7. 话题标签：最多{self.max_hashtags}个，#融资 #加密货币等贴合文章内容的标签
