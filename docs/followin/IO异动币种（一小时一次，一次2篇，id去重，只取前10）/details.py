...
response = requests.post('https://api.followin.io/tag/discussion/summary', headers=headers, json=json_data)

# Note: json_data will not be serialized by requests
# exactly as it was in the original request.
#data = '{"id":10052}'
#response = requests.post('https://api.followin.io/tag/discussion/summary', headers=headers, data=data)
